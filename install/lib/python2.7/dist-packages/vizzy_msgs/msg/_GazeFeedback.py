...
"""autogenerated by genpy from vizzy_msgs/GazeFeedback.msg. Do not edit."""
import sys
...
class GazeFeedback(genpy.Message):
  _md5sum = "c925c4396ef8f121f68659b242138ea2"
  _type = "vizzy_msgs/GazeFeedback"
...
float64[] effort
"""
  __slots__ = ['state_reached','fixation_point','fixation_point_error','velocity_error','joint_states']
  _slot_types = ['bool','geometry_msgs/PointStamped','float64','float64','sensor_msgs/JointState']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       state_reached,fixation_point,fixation_point_error,velocity_error,joint_states
    ...
    """
    if args or kwds:
      super(GazeFeedback, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_5d3I().pack(_x.fixation_point.point.x, _x.fixation_point.point.y, _x.fixation_point.point.z, _x.fixation_point_error, _x.velocity_error, _x.joint_states.header.seq, _x.joint_states.header.stamp.secs, _x.joint_states.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.fixation_point.point.x, _x.fixation_point.point.y, _x.fixation_point.point.z, _x.fixation_point_error, _x.velocity_error, _x.joint_states.header.seq, _x.joint_states.header.stamp.secs, _x.joint_states.header.stamp.nsecs,) = _get_struct_5d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
