...
let CartesianGoal = require('./CartesianGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CartesianActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CartesianGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CartesianGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CartesianActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CartesianGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CartesianGoal()
    }
...
module.exports = CartesianActionGoal;
