...
let GazeGoal = require('./GazeGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class GazeActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GazeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GazeGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GazeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GazeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GazeGoal()
    }
