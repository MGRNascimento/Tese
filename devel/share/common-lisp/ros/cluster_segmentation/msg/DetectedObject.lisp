...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cluster_segmentation-msg:<DetectedObject> is deprecated: use cluster_segmentation-msg:DetectedObject instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster_segmentation-msg:label-val is deprecated.  Use cluster_segmentation-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster_segmentation-msg:cloud-val is deprecated.  Use cluster_segmentation-msg:cloud instead.")
  (cloud m))

(cl:ensure-generic-function 'mesh-val :lambda-list '(m))
(cl:defmethod mesh-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster_segmentation-msg:mesh-val is deprecated.  Use cluster_segmentation-msg:mesh instead.")
  (mesh m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cluster_segmentation-msg:pose-val is deprecated.  Use cluster_segmentation-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObject>)))
  ...
  "cluster_segmentation/DetectedObject")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObject)))
  "Returns string type for a message object of type 'DetectedObject"
  "cluster_segmentation/DetectedObject")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectedObject>)))
  ...
  "2c75e8bafbff5437ef128beeebd74800")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectedObject)))
  "Returns md5sum for a message object of type 'DetectedObject"
  "2c75e8bafbff5437ef128beeebd74800")
