...
(cl:defmethod cl:initialize-instance :after ((m <JointCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obj_recognition-msg:<JointCommand> is deprecated: use obj_recognition-msg:JointCommand instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <JointCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obj_recognition-msg:mode-val is deprecated.  Use obj_recognition-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <JointCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obj_recognition-msg:command-val is deprecated.  Use obj_recognition-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <JointCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obj_recognition-msg:names-val is deprecated.  Use obj_recognition-msg:names instead.")
  (names m))
