...
"""autogenerated by genpy from vizzy_msgs/CartesianResult.msg. Do not edit."""
import sys
...
class CartesianResult(genpy.Message):
  _md5sum = "480f367d9a3455de8c5b570394393f40"
  _type = "vizzy_msgs/CartesianResult"
...
float64 w
"""
  __slots__ = ['state_reached','end_effector_pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       state_reached,end_effector_pose
    ...
    """
    if args or kwds:
      super(CartesianResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.state_reached, _x.end_effector_pose.header.seq, _x.end_effector_pose.header.stamp.secs, _x.end_effector_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state_reached, _x.end_effector_pose.header.seq, _x.end_effector_pose.header.stamp.secs, _x.end_effector_pose.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
