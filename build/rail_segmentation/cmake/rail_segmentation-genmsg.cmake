...
get_filename_component(_filename "/home/miguel/catkin_ws/src/rail_segmentation/srv/RemoveObject.srv" NAME_WE)
add_custom_target(_rail_segmentation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rail_segmentation" "/home/miguel/catkin_ws/src/rail_segmentation/srv/RemoveObject.srv" ""
)
...
_generate_srv_cpp(rail_segmentation
  "/home/miguel/catkin_ws/src/rail_segmentation/srv/RemoveObject.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rail_segmentation)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rail_segmentation\")")
  # install generated code
  install(
